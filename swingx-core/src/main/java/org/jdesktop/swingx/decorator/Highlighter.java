...
/**
 * {@code Highlighter} provide a mechanism to modify visual attributes of
 ...
 * {@code ComponentAdapter}.
 * <p>
 * 
 * For example, in data visualization components that support multiple columns
 * with potentially different types of data, a {@code ColorHighlighter}
 ...
 * rendered component installs a listener to its {@code Highlighter}s
...
public interface Highlighter {
    ...
    /**
     * Adds a {@code ChangeListener} which are
     ...
     * registered on this {@code LegacyHighlighter}.
     *
