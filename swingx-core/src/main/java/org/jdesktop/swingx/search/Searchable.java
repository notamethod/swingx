...
public interface Searchable {
    ...
    /**
     * Search {@code searchString} from the beginning of a document.
     *
     * @param searchString {@code String} we should find in a document.
     *
     * @return index of matched {@code String} or -1 if a match cannot be found.
     */
    public int search(String searchString);
    
    /**
     * Search {@code searchString} from the given position in a document.
     *
     * @param searchString {@code String} we should find in a document.
    ...
    /**
     * Search {@code searchString} in the given direction from the some position in a document.
     *
     * @param searchString {@code String} we should find in a document.
     * @param startIndex Start position in a document or -1 if we want to search from the beginning.
     * @param backward Indicates search direction, will search from the given position towards the 
     *                 beginning of a document if this parameter is {@code true}.
     *
     * @return index of matched {@code String} or -1 if a match cannot be found.
     */
     ...
     *
     * @return  index of matched {@code Pattern} or -1 if a match cannot be found.
     */
