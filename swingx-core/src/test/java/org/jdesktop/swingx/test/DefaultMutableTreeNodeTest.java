...
public class DefaultMutableTreeNodeTest implements
       MutableTreeNode
{
    //private static final long serialVersionUID = -4298474751201349152L;

    DefaultMutableTreeNodeTest(Object[] d) {
        this(d, true);
        data = d;
    }
     ...
     *                   the node's data
     */
    public DefaultMutableTreeNodeTest(Object userObject) {
     ...
     */
    public DefaultMutableTreeNodeTest(Object userObject, boolean allowsChildren) {
        super();
        parent = null;
     ...
     */
    public DefaultMutableTreeNodeTest getParent() {
        return (DefaultMutableTreeNodeTest) parent;
    }
    ...
    @Override
    public DefaultMutableTreeNodeTest getChildAt(int index) {
        if (children == null) {
            throw new ArrayIndexOutOfBoundsException("node has no children");
        }
        return (DefaultMutableTreeNodeTest) children.elementAt(index);
    }
    ...
    public int getDepth() {
        ...
        return ((DefaultMutableTreeNodeTest)last).getLevel() - getLevel();
    }
    ...
    public Object[] getUserObjectPath() {
        ...
        for(int counter = 0; counter < realPath.length; counter++)
            retPath[counter] = ((DefaultMutableTreeNodeTest)realPath[counter])
                               .getUserObject();
        return retPath;
    }
     ...
     */
    public DefaultMutableTreeNodeTest getNextNode() {
        if (getChildCount() == 0) {
            // No children, so look for nextSibling
            DefaultMutableTreeNodeTest nextSibling = getNextSibling();

            if (nextSibling == null) {
                DefaultMutableTreeNodeTest aNode = (DefaultMutableTreeNodeTest)getParent();
                ...
                do {
                    ...
                    aNode = (DefaultMutableTreeNodeTest)aNode.getParent();
                } while(true);
            } else {
                return nextSibling;
            }
        } else {
            return (DefaultMutableTreeNodeTest)getChildAt(0);
        }
    }
     ...
     */
    public DefaultMutableTreeNodeTest getPreviousNode() {
        DefaultMutableTreeNodeTest previousSibling;
        DefaultMutableTreeNodeTest myParent = (DefaultMutableTreeNodeTest)getParent();
    ...
    public boolean isNodeSibling(TreeNode anotherNode) {
        ...
        if (anotherNode == null) {
            ...
            if (retval && !((DefaultMutableTreeNodeTest)getParent())
     ...
     */
    public DefaultMutableTreeNodeTest getNextSibling() {
        DefaultMutableTreeNodeTest retval;
        ...
        if (myParent == null) {
            ...
            retval = (DefaultMutableTreeNodeTest)myParent.getChildAfter(this);      // linear search
        }
     ...
     */
    public DefaultMutableTreeNodeTest getPreviousSibling() {
        DefaultMutableTreeNodeTest retval;
        ...
        if (myParent == null) {
            ...
            retval = (DefaultMutableTreeNodeTest)myParent.getChildBefore(this);     // linear search
        }
     ...
     */
    public DefaultMutableTreeNodeTest getFirstLeaf() {
        DefaultMutableTreeNodeTest node = this;

        while (!node.isLeaf()) {
            node = (DefaultMutableTreeNodeTest)node.getFirstChild();
        }
     ...
     */
    public DefaultMutableTreeNodeTest getLastLeaf() {
        DefaultMutableTreeNodeTest node = this;

        while (!node.isLeaf()) {
            node = (DefaultMutableTreeNodeTest)node.getLastChild();
        }
     ...
     */
    public DefaultMutableTreeNodeTest getNextLeaf() {
        DefaultMutableTreeNodeTest nextSibling;
        DefaultMutableTreeNodeTest myParent = (DefaultMutableTreeNodeTest)getParent();
     ...
     */
    public DefaultMutableTreeNodeTest getPreviousLeaf() {
        DefaultMutableTreeNodeTest previousSibling;
        DefaultMutableTreeNodeTest myParent = (DefaultMutableTreeNodeTest)getParent();
     ...
     */
    public Object clone() {
        DefaultMutableTreeNodeTest newNode;

        try {
            newNode = (DefaultMutableTreeNodeTest)super.clone();
