 ...
 * <p>A shadow is generated as a {@code BufferedImage} from another
 ...
 * <p>{@code ShadowRenderer} is not guaranteed to be thread-safe.</p>
 * 
...
public class ShadowRenderer {
     ...
     * value are provided as {@code Integer} instances.</p>
     */
     ...
     * <p>When the property change event is fired, the old value and the new
     * value are provided as {@code Float} instances.</p>
     */
