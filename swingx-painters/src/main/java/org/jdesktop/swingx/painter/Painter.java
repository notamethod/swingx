 ...
 * it requires a {@code Component}, allowing the paint method to be type safe. Ex:</p>
 * <pre>{@code
...
public interface Painter<T> {
     ...
     * For example, it could be of type {@code Component}. A <code>Painter</code>
     ...
     * parameter is null.</p>
     *
     * <p>Finally, the {@code width} and <code>height</code> arguments specify the
